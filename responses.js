...
const eventDate = (event) => {
    return `${dateFormat(event.date, "ddd mmm dd yyyy HH:MM:ss 'UTC'o")} ([Convert](https://timee.io/${dateFormat(event.date, "UTC:yyyymmdd'T'HHMM")}?tl=${encodeURIComponent(event.clean_text)}))`
}
